...
const getRetirementData = async () => {
  ...
  retirementDOBPlusSixMonths.setMonth(
    retirementDOBPlusSixMonths.getMonth() + 6
  );
  ...
  if (retirementData.length === 0) {
    console.log(
      `No employees found who will be ${retirementAge} in the next 6 months.`
    );
  }

  console.log(
    `Employees who will be ${retirementAge} in the next 6 months:`,
    retirementData
  );
